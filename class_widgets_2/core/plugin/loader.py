...
from class_widgets_2.core.directories import BUILTIN_PLUGINS_PATH
from class_widgets_2.core.plugin import CW2Plugin, PluginAPI
from class_widgets_2.core.plugin.api import __version__ as __API_VERSION__
from class_widgets_2.plugins import BUILTIN_PLUGINS
...
class PluginLoader:
    ...
    def _inject_runtime_sdk(self):
        ...
        try:
            from class_widgets_2.core.plugin.api import PluginAPI as RealPluginAPI
            from class_widgets_2.core.plugin import CW2Plugin as RealCW2Plugin
            from class_widgets_2.core.config.model import ConfigBaseModel as RealConfigBaseModel
            
            # API组件类
            from class_widgets_2.core.plugin.components import (
            ...
            # 通知相关类型
            from class_widgets_2.core.notification.provider import NotificationProvider as RealNotificationProvider
            from class_widgets_2.core.notification.model import NotificationLevel, NotificationData, NotificationProviderConfig
            
            # 课程表相关类型
            from class_widgets_2.core.schedule.model import EntryType, WeekType
